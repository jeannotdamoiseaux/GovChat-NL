...
#     async def generate_paragraph_version(paragraph, temperature):
#         chat_request = {
#             "model": model_id,
#             "messages": [
#                 {
...
#     async def select_best_version(paragraph, versions):
#         selection_request = {
#             "model": model_id,
#             "messages": [
#                 {
...
#     # Functie om een paragraaf volledig te verwerken (genereren + selecteren)
#     async def process_paragraph(paragraph):
#         # Genereer alle drie versies gelijktijdig
#         version_tasks = [generate_paragraph_version(paragraph, temp) for temp in temperatures]
#         versions = await asyncio.gather(*version_tasks)
        
#         # Selecteer de beste versie
#         result = await select_best_version(paragraph, versions)
#         return result
...
#         # Verwerk alle paragrafen gelijktijdig
#         paragraph_tasks = [process_paragraph(paragraph) for paragraph in paragraphs]
#         all_paragraph_results = await asyncio.gather(*paragraph_tasks)
        
#         # Combineer alle geselecteerde paragrafen tot één tekst
#         combined_text = "\n\n".join([result["translated"] for result in all_paragraph_results])
...
#             },
#             "meta": {
#                 "paragraph_count": len(all_paragraph_results),
#                 "paragraph_details": [
#                     {
#                         "selected_version": result["selected_version"],
#                         "temperature": result["temperature"]
#                     } for result in all_paragraph_results
#                 ]
#             }
#         }
